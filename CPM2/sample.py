...
class Sample:
    ...
    def do_step(self):
        self.cpm.I,self.cpm.A,self.cpm.P = do_step(self.cpm.I, self.cpm.num_x, self.cpm.num_y, self.zmasks.dP_z, self.cpm.A, self.cpm.P, self.cpm.lambda_A, self.cpm.lambda_P, self.cpm.A0, self.cpm.P0, self.cpm.J_diff, self.T,self.zmasks.primes,self.zmasks.hashes)

    def do_steps(self):
        self.cpm.I,self.cpm.A,self.cpm.P = do_steps(self.n_steps,self.cpm.I, self.cpm.num_x, self.cpm.num_y, self.zmasks.dP_z, self.cpm.A, self.cpm.P, self.cpm.lambda_A, self.cpm.lambda_P, self.cpm.A0, self.cpm.P0, self.cpm.J_diff, self.T,self.zmasks.primes,self.zmasks.hashes)
