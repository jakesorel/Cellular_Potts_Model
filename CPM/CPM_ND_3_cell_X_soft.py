...
lambda_A, lambda_P, W, P0, A0 = get_normal_params(p0=7, r=100, beta=0.4, gamma=0, delta=0.7,epsilon=0.8, A0=30)
...
#     if cll.type is "X":
#         cll.P0 = 8
cpm.set_lambdP(np.array([0.0, lambda_P, lambda_P,lambda_P*0.5]))
