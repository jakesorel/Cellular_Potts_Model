...
def do_job(inputt):
    ...
    save_npz("three_cell_results_p0_T/%d_%d.npz"%(int(Id),int(sys.argv[1])), I_SAVE)


if __name__ == "__main__":
    if not os.path.exists("three_cell_results_p0_T"):
        os.makedirs("three_cell_results_p0_T")
    n_param_step = 25
